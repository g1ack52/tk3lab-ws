...
dft_world=${TK3LAB_WS}/gazebo/worlds/quad.world

# Genom3 components to run

#rotorcraft: interfaccia robot 
#nhfc: controllore veicolo underactuated
#pom: stima dello stato
#optitrack: sorgente della posa simulata
#maneuver: generazione traiettorie 
components="
  rotorcraft 
  nhfc
  pom
